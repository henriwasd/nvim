...
Minha configuração pessoal do Neovim, baseada no [kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim), mas personalizada para o meu fluxo de trabalho como desenvolvedor Fullstack.

### Features

- **Linguagens:** Suporte completo para React (TypeScript/TSX), Node.js, Flutter/Dart e Lua.
- **IA:** Autocomplete inteligente usando o **Google Gemini** (via `minuet-ai.nvim`).
- **Navegação:** Explorador de arquivos **Oil.nvim** (edite seu sistema de arquivos como um buffer de texto).
- **Terminal:** Terminal flutuante e em split integrado com **ToggleTerm**.
- **Code Folding:** Dobramento de código inteligente com **nvim-ufo**.
- **Tema:** Gruvbox (versão moderna em Lua).
- **Performance:** Carregamento preguiçoso (lazy loading) para um início instantâneo.

## Installation

### Install Neovim

Esta configuração requer o Neovim 'stable' (0.10+) ou 'nightly'.

### External Dependencies

- Basic utils: `git`, `make`, `unzip`, `gcc`
- [ripgrep](https://github.com/BurntSushi/ripgrep), [fd](https://github.com/sharkdp/fd)
- [Nerd Font](https://www.nerdfonts.com/) (recomendado para ícones)
- **Linguagens:** `node`, `npm`, `flutter` (dart)
...
2. O **Lazy.nvim** instalará todos os plugins automaticamente.
3. Para o autocomplete de IA, adicione sua `GEMINI_API_KEY` ao seu `.bashrc`:
   ```bash
